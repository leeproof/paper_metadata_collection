...
def _get_service_account_info() -> Optional[dict]:
    ...
    - st.secrets["gdrive_service_account"] 가 dict 또는 str 모두 대응
    - 예외 시 간단 디버그 힌트 로그
    """
    import json as _json
...
def _gdrive_locate_piece(issn: str, year: int):
    ...
    if not root_id:
        raise RuntimeError("https://drive.google.com/drive/folders/1QdzSKunOoKZ5jCf2CRIG3ESZlKsPt_in?usp=drive_link")
