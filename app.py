...
st.set_page_config(page_title="OpenAlex Pipeline", layout="wide")
...
def app():
    ...
    if not csv_files:
        st.info("아직 생성된 CSV가 없습니다. 사이드바 설정 후 🚀 실행 버튼을 눌러주세요.")
        return
    ...
    # 예: foo_ror_extract_name.csv → foo_ror_extract_name_network.html
