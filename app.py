...
def _summary_metrics_table(final_csv_path: str, centrality: str = "eigenvector"):
    ...
    base_path = final_csv.with_suffix("")   # ..._1992_1992[_ror_extract_name]
    base = str(base_path)
    ...
    if csv_file.exists():
        ...
        # 병합 CSV라면 per-year CSV 합산으로 대체할 수도 있음(원하면 활성화)
        pass
    ...
    dir_cands = [final_csv.parent, final_csv.parent / "workdir_tmp"]
