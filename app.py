...
def _summary_metrics_table(final_csv_path: str, centrality: str = "eigenvector"):
    ...
    cent_csv    = None
    for c in [
        Path(f"{base}_centrality_{centrality}_{centrality}.csv"),
        Path(f"{base}_centrality_{centrality}_degree.csv"),
        Path(f"{base}_centrality_degree_{centrality}.csv"),
        Path(f"{base}_centrality_degree_degree.csv"),
        Path(f"{base}_centrality_eigenvector_eigenvector.csv"),
    ]:
        if c.exists():
            cent_csv = c
            break
