...
def app():
    ...
    def _render_preview_block(sel_csv: str):
        ...
        with st.expander("네트워크 Preview (Degree / Eigenvector / Betweenness / Closeness)", expanded=False):
            ...
            st.caption("※ 안내: 공통 요약 표의 '노드/엣지 수'는 **최종 CSV 전체**를 기준으로 계산됩니다. "
                        "아래 미리보기 네트워크는 **중앙성 기준으로 상위 노드들을 강조/필터링**하여 "
                        "요약의 수치와 다를 수 있습니다. 전체 네트워크는 위의 'Visualization 다운로드' HTML에서 확인하세요.")
