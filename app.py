...
if "view" not in st.session_state:
    ...
    st.session_state.view = _default if _default in ("Preview", "Download", "Summary") else "Preview"
...
def app():
    ...
    def _render_summary_block(sel_csv: str):
        with st.expander("Summary", expanded=True):
            ...
            # 2) Summary CSV Download (index=False, UTF-8-SIG)
    ...
    if run_btn:
        ...
        # ✅ 라디오 박스 복원: Preview / Download / Summary
        view = st.radio(
            "보기 선택",
            ["Preview", "Download", "Summary"],
            index=["Preview","Download","Summary"].index(st.session_state.view),
            key="_view_radio",
            horizontal=True,
        ...
        # ✅ Summary가 항상 붙도록(Download 후 rerun되어도)
